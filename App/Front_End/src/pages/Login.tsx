...
import { Eye, EyeOff, AlertCircle, CheckCircle2, Calendar, Users, DollarSign, Activity, Shield, Clock, Award, LogIn } from "lucide-react";
...
const DEMO_CREDENTIALS = [
  ...
  { role: "Nurse", email: "nurse@mail.com", password: "12345678", color: "#06b6d4" },
];
...
function ToothSVG() {
  return (
    <svg viewBox="0 0 40 44" fill="white" style={{ width: 20, height: 20 }}>
      <path d="M20 2C15 2 10 6 10 12c0 3 .8 5.5 2 7.5L14 42h12l2-22.5c1.2-2 2-4.5 2-7.5 0-6-5-10-10-10z" />
      <path d="M14 22h12" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5" strokeLinecap="round" fill="none" />
    </svg>
  );
}
...
export default function LoginPage() {
  ...
  // Show right panel on wide screens
  useEffect(() => {
    const show = () => {
      if (rightRef.current)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Welcome back, ${data.user.fullName}!`, {
        icon: '👋',
        style: { borderRadius: '10px', background: '#0f1a14', color: '#fff' }
      });
      navigate("/");
    } catch (err: any) {
  ...
  const handleDemoLogin = async (role: string, credEmail: string, credPassword: string) => {
    ...
    try {
      ...
      toast.success(`Logged in as ${role}!`, {
        icon: '✓',
        style: { borderRadius: '10px', background: '#0d9e75', color: '#fff' }
      });
      navigate("/");
    } catch (err: any) {
      setErrorMsg(err?.response?.data?.error ?? "Demo login failed. Please try again.");
    ...
    <>
      <style>{`
        ...
        * {
        ...
        .login-input:focus { 
          border-color:#0d9e75; 
          box-shadow:0 0 0 4px rgba(13,158,117,0.1);
        }
        .login-input.has-err { 
          border-color:#ef4444; 
          background:#fef2f2;
        }
        .login-input.has-err:focus { 
        ...
        .login-btn {
          ...
          box-shadow:0 4px 6px -1px rgba(13,158,117,0.2), 0 2px 4px -1px rgba(13,158,117,0.1);
          transition:all 0.2s ease;
        }
        .login-btn:hover:not(:disabled) { 
          background:#0b8a66; 
          transform:translateY(-2px);
          box-shadow:0 10px 15px -3px rgba(13,158,117,0.3), 0 4px 6px -2px rgba(13,158,117,0.2);
        }
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ display:"flex", alignItems:"center", gap:12 }}>
              <div style={{
                ...
                flexShrink:0, boxShadow:"0 4px 10px rgba(13,158,117,0.3)",
              }}>
                <img src="/icon.png" alt="Logo" style={{ width:40, height:40 }} />
                {/* <ToothSVG /> */}
              </div>
              <div>
                <span style={{ fontSize:20, fontWeight:700, color:"#0f1a14", letterSpacing:"-0.02em", display:"block" }}>
                  {APP_NAME}
                </span>
                <span style={{ fontSize:12, color:"#64748b", marginTop:2, display:"block" }}>
                  Professional Dental Suite
                </span>
              </div>
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ marginBottom:32 }}>
              <h1 style={{ 
                ...
                color:"#0f1a14", marginBottom:12, lineHeight:1.2 
              }}>
                Welcome back
              </h1>
              <p style={{ fontSize:16, color:"#64748b", lineHeight:1.5 }}>
                Sign in to access your personalized clinic dashboard
              </p>
            </div>
            ...
            {errorMsg && (
              <div style={{
                ...
                marginBottom:24, fontSize:14, color:"#b91c1c",
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div style={{ marginBottom:20 }}>
                ...
                <input
                  ...
                  className={`login-input${errorMsg ? " has-err" : ""}`}
                ...
                <div style={{ 
                  ...
                  <button 
                    ...
                    style={{ 
                      ...
                      color:"#0d9e75", fontFamily:"inherit", 
              ...
              {/* Submit button */}
              <button type="submit" className="login-btn" disabled={loading || demoLoading !== null}>
                {loading ? <><Spinner />Signing in...</> : "Sign in to dashboard"}
              </button>
            </form>

            {/* Demo credentials section - NOW WITH ACTUAL LOGIN */}
            <div style={{ 
              marginTop:28, 
              padding:"20px", 
              background:"linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)", 
              ...
              <p style={{ 
                ...
                Click any role below to instantly log in and explore the dashboard
              </p>
              ...
              <div style={{ 
                ...
                {DEMO_CREDENTIALS.map((cred) => (
                  <button
                    ...
                    style={{
                      borderColor: selectedRole === cred.role ? cred.color : '#e2e8f0',
                      background: selectedRole === cred.role ? '#f8fafc' : '#fff',
                      opacity: demoLoading === cred.role ? 0.7 : 1,
                    }}
                  >
                    <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                      <span style={{
                        ...
                        boxShadow: selectedRole === cred.role ? '0 0 0 2px rgba(0,0,0,0.1)' : 'none'
                      }} />
                      <span>{cred.role}</span>
                    </div>
          ...
          {/* Footer with eALIF Team branding */}
          <div style={{ 
        ...
        >
          ...
          <div style={{ 
            ...
            background: "radial-gradient(circle at 20% 50%, rgba(13,158,117,0.03) 0%, transparent 50%)",
          }} />
          <div style={{ 
          ...
          <div style={{ maxWidth:600, width:"100%" }}>
            ...
            <div style={{
              ...
              {/* Card header with eALIF branding */}
              <div style={{ 
                padding:"16px 20px", 
                ...
                {[
                  ...
                  >
                    ...
                    <div style={{ 
                      ...
                      background: k.positive ? "#f0fdf4" : "#fef2f2",
                      padding:"2px 8px",
                      borderRadius:100,
              ...
              {/* Schedule section with role indicator */}
              <div style={{ 
                padding:"12px 20px", 
                display:"flex",
                alignItems:"center",
                ...
                <div style={{ fontSize:12, fontWeight:600, letterSpacing:"0.05em", textTransform:"uppercase", color:"#64748b" }}>
                  Today's schedule · Dr. Ahmed's list
                </div>
                <div style={{
                  fontSize:11,
                  padding:"4px 10px",
              ...
              {SCHEDULE.map((row, i) => (
                ...
                >
                  ...
                  <div style={{ 
                    width:8, height:8, 
                    borderRadius:"50%", 
                    background: STATUS_COLORS[row.status as keyof typeof STATUS_COLORS],
                  ...
                  <span style={{ 
                    ...
                    background:row.bBg, color:row.bTx,
              ...
              {/* Card footer with eALIF attribution */}
              <div style={{ 
                padding:"14px 20px", 
                borderTop:"1px solid #e2e8f0", 
                display:"flex", 
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <span style={{ fontSize:13, color:"#334155" }}>
                  Powered by <strong style={{ color:"#667eea" }}>eALIF Team Suite</strong>
                </span>
              </div>
            </div>
          </div>
