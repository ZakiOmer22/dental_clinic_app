...
// DENTIST ONLY ROUTES - exactly what you showed in the comments
const DENTIST_NAV_SECTIONS = [
  {
    label: "Main",
    items: [
      { path: "/", label: "Dashboard", icon: LayoutDashboard },
      { path: "/doctor/patients", label: "Patients", icon: Users },
      { path: "/doctor/patients/:id", label: "Patient Profile", icon: Users },
      { path: "/doctor/appointments", label: "Appointments", icon: CalendarDays },
      { path: "/doctor/treatments", label: "Treatments", icon: Stethoscope },
    ],
  },
  {
    label: "Clinical",
    items: [
      ...
      { path: "/doctor/consent-forms", label: "Consent Forms", icon: FileText },
      { path: "/doctor/referrals", label: "Referrals", icon: Users },
    ],
  },
  {
    label: "Operations",
...
export default function Sidebar() {
  ...
  // Use dentist sections
  const NAV_SECTIONS = DENTIST_NAV_SECTIONS;
