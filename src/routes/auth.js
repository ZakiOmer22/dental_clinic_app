  ...
  try {
    ...
    const emailHtml = `
      ...
      <body style="margin:0;padding:20px;background:#f4f7f9;">
        <div class="container">
          <div class="header">
            <img src="${logoUrl}" alt="Daryeel App — Multi-Clinic Dental SaaS Platform" class="logo" style="width:64px;height:64px;">
          ...
          <div class="content">
            ...
            <div class="message">
              We received a request to reset the password for your Daryeel App — Multi-Clinic Dental SaaS Platform account. 
          ...
          <div class="footer">
            <p>© ${currentYear} Daryeel App — Multi-Clinic Dental SaaS Platform – All rights reserved.</p>
    ...
    try {
      ...
      const mailOptions = {
        from: '"Daryeel App — Multi-Clinic Dental SaaS Platform" <noreply@dentalclinic.com>',
        to: user.email,
        subject: 'Reset Your Password - Daryeel App — Multi-Clinic Dental SaaS Platform',
        html: emailHtml,
      };
